...
# Import using new module name
import bayesian_filters
from bayesian_filters import *
import bayesian_filters.kalman

# For backward compatibility, set filterpy as an alias
import sys
sys.modules['filterpy'] = bayesian_filters
filterpy = bayesian_filters
...
release = bayesian_filters.__version__
